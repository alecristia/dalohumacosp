...
```{r readin-final}
read.table("/Users/acristia/Documents/dalohumacosp/derivedFiles/ds_jsalt.txt",header=T)->ds
...
write.table(diar,"/Users/acristia/Documents/dalohumacosp/derivedFiles/casj_diar.txt",row.names=F,sep="\t")
...
```{r diar-perf}
read.table("/Users/acristia/Documents/dalohumacosp/derivedFiles/casj_diar.txt",header=T)->diar
...
write.table(ntall,"/Users/acristia/Documents/dalohumacosp/derivedFiles/casj_ntalkers.txt",row.names=F,quote=T,sep="\t")
